...
class ReleaseData(object):
    ...
    def putfile(self):
        ...
        if delivery_method == "1":
            ...
            os.system("tree -h %s > tree_record/%s_%s-tree.txt && obsutil cp -r -f tree_record/%s_tree.txt obs://backup-nextomics-wh/Record/%s/%s/"%(project_name,now_time,project_name,project_name,project_name,now_time))
